...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun  6 19:56:31 2019
...
ordinal_features1 = ["ExterQual", "ExterCond", "BsmtQual", 
                     "BsmtCond", "GarageQual", "GarageCond",
                     "PoolQC", "FireplaceQu", "KitchenQual", "HeatingQC"]
...
#============================================================================
# res = model_selection.cross_val_score(dt_estimator, X_train, y_train, cv=10
# math.sqrt(-res)
# 
#============================================================================
