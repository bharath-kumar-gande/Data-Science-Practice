...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul  2 19:31:58 2019
...
def findChild(passenger): # This is wrong: written comparision statement on child so its changing only Age with Adult as A < C
    age,sex = passenger
