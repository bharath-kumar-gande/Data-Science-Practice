...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul 23 11:52:40 2019
...
# 
# =============================================================================
os.chdir("/Users/bharath/Desktop/Folder/Data Science/Projects/digit-recognizer")
np.random.seed(100)
...
model.add(Dense(128,  input_shape=(256,), activation='sigmoid'))
...
history = model.fit(x=X_train, y=y_train, verbose=1, epochs=10, batch_size=5, validation_split=0.2)
